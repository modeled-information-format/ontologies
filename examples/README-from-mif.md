---
id: examples-readme-from-mif
type: semantic
created: '2026-07-01T00:00:00Z'
diataxis_type: reference
---

> Preserved verbatim from the `MIF` repo's `ontologies/README.md`, moved here
> along with `examples/` when MIF's leftover ontology-content directory was
> retired (no ontology content belongs in MIF; `ontologies.schema.json` is
> MIF's domain, `*.ontology.yaml` content is this repo's domain). Some paths
> and tooling references below (e.g. `python scripts/yaml2jsonld.py`) are
> MIF-specific and predate this repo; kept as-is rather than rewritten.
